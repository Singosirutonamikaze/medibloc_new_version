 ...
 * @access Private
 */
router.post('/', (0, validation_middleware_1.validationMiddleware)(validation_middleware_2.validationSchemas.createAppointment), appointmentController.createAppointment);
/**
 ...
 * @access Private
 */
router.put('/:id', (0, validation_middleware_1.validationMiddleware)(validation_middleware_2.validationSchemas.updateAppointment), appointmentController.updateAppointment);
/**
