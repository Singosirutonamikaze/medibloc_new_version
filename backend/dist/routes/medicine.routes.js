 ...
 */
router.post('/', (0, validation_middleware_1.validationMiddleware)(validation_middleware_2.validationSchemas.createMedicine), medicineController.createMedicine);
/**
 ...
 * @access Private/Admin
 */
router.put('/:id', (0, validation_middleware_1.validationMiddleware)(validation_middleware_2.validationSchemas.updateMedicine), medicineController.updateMedicine);
/**
