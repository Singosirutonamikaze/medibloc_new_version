 ...
 */
router.post('/', (0, validation_middleware_1.validationMiddleware)(validation_middleware_2.validationSchemas.createMedicalRecord), medicalRecordController.createMedicalRecord);
/**
 ...
 * @access Private/Doctor
 */
router.put('/:id', (0, validation_middleware_1.validationMiddleware)(validation_middleware_2.validationSchemas.updateMedicalRecord), medicalRecordController.updateMedicalRecord);
/**
