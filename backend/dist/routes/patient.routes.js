...
(0, validation_middleware_1.validationMiddleware)(validation_middleware_2.validationSchemas.createPatient), patientController.createPatient);
/**
 ...
 * @access Private
 */
router.put('/:id', (0, validation_middleware_1.validationMiddleware)(validation_middleware_2.validationSchemas.updatePatient), patientController.updatePatient);
/**
