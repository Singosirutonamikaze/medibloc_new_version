...
const validatePattern = (field, value, rules) => {
...
const validateEnum = (field, value, rules) => {
...
const validateCustom = (field, value, rules) => {
...
const validateStringType = (field, value, rules) => {
...
const validateNumberType = (field, value, rules) => {
...
const validateBooleanType = (field, value, rules) => {
...
const validateEmailType = (field, value, rules) => {
...
const validateDateType = (field, value, rules) => {
...
const validateArrayType = (field, value, rules) => {
