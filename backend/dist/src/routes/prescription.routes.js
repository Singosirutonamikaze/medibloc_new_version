 ...
 */
router.post('/', (0, validation_middleware_1.validationMiddleware)(validation_middleware_1.validationSchemas.createPrescription), prescriptionController.createPrescription);
/**
