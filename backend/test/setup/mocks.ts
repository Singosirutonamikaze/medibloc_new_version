...
const makeControllerMock = (resourceName: string) => ({
  [`${resourceName}Controller`]: class {
    ...
    getPatientById = (req: Request<{ id?: string }>, res: Response) =>
      res.json({
        success: true,
        data: { id: req.params.id ?? 1, firstName: "koffi", lastName: "komla" },
      });
    updatePatient = (
      ...
      res.json({
        success: true,
        data: { id: req.params.id ?? 1, ...req.body },
      });
    ...
    updateAppointmentStatus = (
      ...
      const body = req.body;
      const status =
        typeof body.status === "string" ? body.status : "confirmed";
      return res.json({
        success: true,
        data: { id: req.params.id ?? 1, status },
      });
    };
    createAppointment = (
      req: Request<{}, {}, AppointmentPayload>,
      res: Response,
    ...
    getDiseaseById = (req: Request<{ id?: string }>, res: Response) =>
      res.json({
        success: true,
        data: { id: req.params.id ?? 1, name: "TestDisease" },
      });
    updateDisease = (
      req: Request<{ id?: string }, {}, RequestBody>,
      res: Response,
    ...
    addSymptomToDisease = (
      req: Request<{ id?: string; symptomId?: string }>,
      res: Response,
    ...
    getSymptomById = (req: Request<{ id?: string }>, res: Response) =>
      res.json({
        success: true,
        data: { id: req.params.id ?? 1, name: "Cough" },
      });
    updateSymptom = (
      req: Request<{ id?: string }, {}, RequestBody>,
      res: Response,
    ...
    getMedicineById = (req: Request<{ id?: string }>, res: Response) =>
      res.json({
        success: true,
        data: { id: req.params.id ?? 1, name: "Aspirin" },
      });
    updateMedicine = (
      req: Request<{ id?: string }, {}, RequestBody>,
      res: Response,
    ...
    getMedicinesByType = (req: Request<{ type?: string }>, res: Response) =>
      res.json({
        success: true,
        data: [{ id: 1, type: req.params.type ?? "pill", name: "Aspirin" }],
      });
    getMedicinesByPharmacy = (
      req: Request<{ pharmacyId?: string }>,
      res: Response,
    ) =>
      res.json({
        success: true,
        data: [
          { id: 1, pharmacyId: req.params.pharmacyId ?? "1", name: "Aspirin" },
        ],
      });
    ...
    getPharmacyById = (req: Request<{ id?: string }>, res: Response) =>
      res.json({
        success: true,
        data: { id: req.params.id ?? 1, name: "Pharma" },
      });
    updatePharmacy = (
      req: Request<{ id?: string }, {}, RequestBody>,
      res: Response,
    ...
    getPharmaciesByCountry = (
      ...
      res.json({
        success: true,
        data: [
          { id: 1, countryId: req.params.countryId ?? "1", name: "Pharma" },
        ],
      });
    ...
    getPrescriptionById = (req: Request<{ id?: string }>, res: Response) =>
      res.json({
        success: true,
        data: { id: req.params.id ?? 1, medications: "Aspirin" },
      });
    ...
    getPatientPrescriptions = (
      ...
      res.json({
        ...
        data: [
          {
            id: 1,
            patientId: req.params.patientId ?? "1",
            medications: "Aspirin",
          },
        ],
      });
    getDoctorPrescriptions = (
      ...
      res.json({
        ...
        data: [
          {
            id: 1,
            doctorId: req.params.doctorId ?? "1",
            medications: "Aspirin",
          },
        ],
      });
    getPatientMedicalRecords = (
      ...
      res.json({
        success: true,
        data: [
          { id: 1, patientId: req.params.patientId ?? "1", title: "Record" },
        ],
      });
    ...
    getMedicalRecordById = (req: Request<{ id?: string }>, res: Response) =>
      res.json({
        success: true,
        data: { id: req.params.id ?? 1, title: "Record", content: "example" },
      });
    updateMedicalRecord = (
      req: Request<{ id?: string }, {}, RequestBody>,
      res: Response,
    ...
    getDashboardStats = (req: Request, res: Response) =>
      res.json({
        success: true,
        data: { totalPatients: 100, totalAppointments: 250 },
      });
    ...
    getUserById = (req: Request<{ id?: string }>, res: Response) =>
      res.json({
        success: true,
        data: { id: req.params.id ?? 1, email: "koffi@example.com" },
      });
    updateUser = (
      req: Request<{ id?: string }, {}, RequestBody>,
      res: Response,
...
vi.mock("../../src/controllers/patient.controller", () =>
  makeControllerMock("Patient"),
);
vi.mock("../../src/controllers/appointment.controller", () =>
  makeControllerMock("Appointment"),
);
vi.mock("../../src/controllers/doctor.controller", () =>
  makeControllerMock("Doctor"),
);
vi.mock("../../src/controllers/disease.controller", () =>
  makeControllerMock("Disease"),
);
vi.mock("../../src/controllers/symptom.controller", () =>
  makeControllerMock("Symptom"),
);
vi.mock("../../src/controllers/medicine.controller", () =>
  makeControllerMock("Medicine"),
);
vi.mock("../../src/controllers/pharmacy.controller", () =>
  makeControllerMock("Pharmacy"),
);
vi.mock("../../src/controllers/prescription.controller", () =>
  makeControllerMock("Prescription"),
);
vi.mock("../../src/controllers/medicalRecord.controller", () =>
  makeControllerMock("MedicalRecord"),
);
vi.mock("../../src/controllers/stats.controller", () =>
  makeControllerMock("Stats"),
);
vi.mock("../../src/controllers/user.controller", () =>
  makeControllerMock("User"),
);
