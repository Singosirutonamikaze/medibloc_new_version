...
export const StatCard = ({
  ...
  <div className="group relative overflow-hidden rounded-2xl bg-linear-to-br from-white to-gray-50 p-5 shadow-lg hover:shadow-xl transition-all duration-300">
